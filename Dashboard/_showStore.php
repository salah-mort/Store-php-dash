                                            ...
                                            <div class="card-content collapse show">
                                                <div class="card-body card-dashboard">
                                                    <table style="width: 100%" class="table display nowrap table-striped table-bordered scroll-horizontal ">
                                                        <thead>
                                                            <tr class="yu">
                                                                <th style="color:#ffab00;background:#3c6868;">Name</th>
                                                                <th style="color:#ffab00;background:#3c6868;">phone</th>
                                                                <th style="color:#ffab00;background:#3c6868;">address</th>
                                                                <th style="color:#ffab00;background:#3c6868;">description</th>
                                                                <th style="color:#ffab00;background:#3c6868;">category </th>
                                                                <th style="color:#ffab00;background:#3c6868;">image</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $page = $_GET['page'] ?? 1;
                                                            $ofset = ($page - 1) * $limit;
                                                            $query = "SELECT * FROM store ORDER BY id DESC limit $limit offset $ofset";
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    ...
                                                                    echo "<td><img width='50px' height='50px' src='http://localhost/Project-Final/Dashboard/uploads/images/" . $row['image'] . "'></td>";


                                                                    echo "<td> <a href='_editCategory.php?id=" . $row['id'] . "' class='btn btn-primary  btn-outline-danger box-shadow-3 mr-1 mb-1'><i
                                                    ...
                                                    <div class="justify-content-center d-flex">
                                                        <?php
                                                        $query = "select count(id) as rowNumber from store";
                                                        $result = mysqli_query($connection, $query);
